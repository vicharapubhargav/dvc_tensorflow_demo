...
from src.utils.create_callbacks import create_and_save_tensorboard_callback,create_and_save_checkpoint_callback
import argparse
import os
import logging
import io
...
def prepare_callbacks(config_path,params_path):
    ...
    create_and_save_tensorboard_callback(tensorboard_log_dir,callbacks_dir)
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.info("Stage-03 Completed , Tensorboard callbacks and Checkpoint callbacks are created....<<<<<<\n")
